...
The sentiment scores based on bigrams of the associated words surrounding the news reporting of key individuals are illustrated in the following bar charts:
...
The sentiment scores based on bigrams of the associated words surrounding news reporting of the important organizational bodies are also calculated and represented in bar charts as provided below:
...
The above shows the bigram words associated with the key organizations - GASTech, POK, Government and WFA. It is observed WFA, an NGO, had positive sentiment scores during to its supportive role in the community. The Government and POK have fairly balanced spread of positive and negative sentiment scores for the associated bigram words due to their roles and the events occurred. Notably, GASTech has word bigrams in the news texts that was skewed towards negative sentiment scores due to the issues of water contamination which purportedly caused harm to the lives of the people in the community.  
