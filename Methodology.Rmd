...
In the following, text wrangling is performed to obtain a datatable containing the correlated news article pairs with column details on text id, date, title and newsgroup each of the paired news articles. We selected article pairs with high correlation of >0.8. 
