...
## 1.1 Frequency & Duration of the News Articles
...
## 1.2 Further text processing - Stopwords Removal & Stemming
...
Remove meaningless frequent words not removed in stopwords, i.e. title, published & kronos - so that they do not distort the subsequent text visualization:
