...
The sentiment scores based on bigrams ofthe associated words surrounding the news reporting of key individuals are illustrated in the following bar charts:
...
The sentiment scores based on bigrams ofthe associated words surrounding the news reporting of the important organizational bodies are also calculated and represented in the following bar charts:
