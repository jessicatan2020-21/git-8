...
```{r echo=TRUE, eval=TRUE, layout="l-body-outset", fig.width=15, fig.height=12}
tf_idf %>%
  group_by(newsgroup) %>%
...
```{r, layout="l-body-outset", fig.width=14, fig.height=6}
...
```{r, layout="l-body-outset", fig.width=15, fig.height=10}
...
```{r, layout="l-body-outset", fig.height=11}
g <- GAStech_graph %>%
  ggraph(layout = "fr") + 
...
```{r, layout="l-body-outset", fig.width=8}
g <- GAStech_graph %>%
  ggraph(layout = "fr") + 
  geom_edge_link(aes(width=Weight), 
                 alpha=0.2) +
