...
By inputting "POK" in the search tab, all GASTech staff with POK affiliations would be automatically retrieved. In total, there are 5 POK members on GASTech's empployee list, namely, Minke.Mies, Isia.Vann, Loreto.Bodrogi, Hennie.Osvaldo. and Inga.Ferro. To extract all other personnel with external profiles, click on the upward arrow at the "POK/Others" column and you could see all other suspicious member profiles such as Edward.Vann who could be related to the Vann members of POK as well as Ruscella.Mies.Haber (page2) who is aunt of Minke.Mies. Notably, all the staff with POK affiliation are in the Security Department whilst other profiled individuals are in the Administration Department.


## 3.4.3 Identify key email personnels (nodes) by citizenship country:
...
## 3.4.4 Identify key email personnels (nodes) by military service branch:
...
The above network graph shows the majority of the employees do not service Military Service. However, for those employees that had served in military, the majority were in the Armed Forces of Kronos and this is a tightly knitted group with close and well-linked email communication network.

## 3.4.5 View email network mutation over days of the week
